...
/* This simplifies the inequality at the inputted intermediate vector. */
void simplify_inequality(intermediate* starting_interemdiate)
{
    /*
    (3x) > (x + 1)
    (3 x *) (x 1 +) >               RPN
    ( (3 x *) ) ( (x) 1 + ) >       SEPARATE TERMS
    ...
    (2x + 3 - 4) <= (2x - 4)
    (2 x * 3 + 4 -) (2 x * 4 -) <=          RPN
    ( (2 x *) 3 + 4 -) ( (2 x *) 4 -) <=    SEPARATE COMMON TERMS
    (0 3 + 4 -) (0 4 -) <=                  REPLACE COMMON TERMS WITH ZERO
    (0)                                     CONSTANT PASS


    ( 3 x * 2 +) ( 2 y * 3 -) >         RPN
    ( (3 x *) 2 +) ( (2 y *) 3 -) >     SEPARATE TERMS
